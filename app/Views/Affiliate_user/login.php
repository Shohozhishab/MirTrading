...
<head>
    ...
    <title>Shohozhishab | Affiliate User Log in</title>
...
<div class="login-box">
    ...
    <div class="login-box-body">
        <p class="login-box-msg">Sign In To Affiliate User</p>
        <?php $message = isset($_SESSION['message']) ? $_SESSION['message'] : 0; // $session->getFlashdata('error');
        if($message){ ?> <?php print $message; ?> <?php } ?>
        <form action="<?php echo base_url('Affiliate_user/Login/action')?>" method="post">
            <div class="form-group has-feedback">
                <input type="number" class="form-control" name="phone" placeholder="Phone" value="<?php if(isset($_COOKIE['login_phone'])){ echo $_COOKIE['login_phone'];} ?>" required>
