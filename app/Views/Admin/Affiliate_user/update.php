<div class="content-wrapper" id="viewpage">
    ...
    <section class="content-header">
        <h1> Affiliate User <small>Affiliate User Update</small> </h1>
        <ol class="breadcrumb">
            ...
            <div class="col-xs-12">
                ...
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Affiliate User Update</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="col-lg-6" >
                                <form id="geniusform" action="<?php echo $action; ?>" method="post" >
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="name" id="name" placeholder="Name" value="<?= $affiliateUser->name;?>" required>
                                        <div class="error"></div>
                                    </div>
                                    <div class="form-group">
                                        <label for="varchar">Phone</label>
                                        <input type="number" class="form-control" name="phone" id="phone" placeholder="phone" value="<?= $affiliateUser->phone;?>" required>
                                        <div class="error"></div>
                                    </div>

                                    <div class="form-group">
                                        <label for="varchar">commission</label>
                                        <input type="number" class="form-control" name="commission" id="commission" placeholder="commission %" value="<?= $affiliateUser->commission;?>" required>
                                        <div class="error"></div>
                                    </div>

                                    <div class="form-group">
                                        <label for="varchar">Address</label>
                                        <textarea class="form-control" name="address" id="address"><?= $affiliateUser->address;?></textarea>
                                        <div class="error"></div>
                                    </div>
